...
public class WebPageGenerator {
  ...
  static WebPageGenerator() {
    ...
    File.WriteAllText(rootFolder + "css/styles.css", Demo07_CreateShortcut.Properties.Resources.styles_css);
    Directory.CreateDirectory(rootFolder + "js");
    File.WriteAllText(rootFolder + "js/jquery.js", Demo07_CreateShortcut.Properties.Resources.jquery_js);
    File.WriteAllText(rootFolder + "js/powerbi.js", Demo07_CreateShortcut.Properties.Resources.powerbi_js);
  }
  ...
  public static void GenerateReportPageUserOwnsData(string workspaceId, string reportId, bool LaunchInBrowser = true) {
    ...
    string htmlSource = Demo07_CreateShortcut.Properties.Resources.EmbedReport_html;
