...
public class FabricItemDefinitionFactory {
  ...
  public static FabricItemCreateRequest GetDirectLakeSalesModelCreateRequest(string DisplayName, string SqlEndpointServer, string SqlEndpointDatabase) {
    ...
    string part1FileContent = Demo07_CreateShortcut.Properties.Resources.definition_pbidataset;

    string part2FileContent = Demo07_CreateShortcut.Properties.Resources.sales_model_DirectLake_bim
  ...
  public static FabricItemCreateRequest GetSalesReportCreateRequest(string SemanticModelId, string DisplayName) {
    ...
    string part1FileContent = Demo07_CreateShortcut.Properties.Resources.definition_pbir.Replace("{SEMANTIC_MODEL_ID}", SemanticModelId);
    string part2FileContent = Demo07_CreateShortcut.Properties.Resources.sales_report_json;
    string part3FileContent = Demo07_CreateShortcut.Properties.Resources.CY24SU02_json;
  ...
  public static FabricItemCreateRequest GetBronzeLayerNotebookCreateRequest(string WorkspaceId, FabricItem BronzeLakehouse) {

    string displayName = "Build Bronze Layer";
    string codeContent = Demo07_CreateShortcut.Properties.Resources.BuildBronzeLayer_ipynb;

    codeContent = codeContent.Replace("{WORKSPACE_ID}", WorkspaceId)
                             .Replace("{BRONZE_LAKEHOUSE_ID}", BronzeLakehouse.id)
                             .Replace("{BRONZE_LAKEHOUSE_NAME}", BronzeLakehouse.displayName);
  ...
  public static FabricItemCreateRequest GetSilverLayerNotebookCreateRequest(string WorkspaceId, FabricItem SilverLakehouse, FabricItem BronzeLakehouse) {

    string displayName = "Build Silver Layer";
    string codeContent = Demo07_CreateShortcut.Properties.Resources.BuildSilverLayer_ipynb;

    codeContent = codeContent.Replace("{WORKSPACE_ID}", WorkspaceId)
                             .Replace("{SILVER_LAKEHOUSE_ID}", SilverLakehouse.id)
                             .Replace("{BRONZE_LAKEHOUSE_ID}", BronzeLakehouse.id)
                             .Replace("{SILVER_LAKEHOUSE_NAME}", SilverLakehouse.displayName);
  ...
  public static FabricItemCreateRequest GetGoldLayerNotebookCreateRequest(string WorkspaceId, FabricItem GoldLakehouse, FabricItem SilverLakehouse) {

    string displayName = "Build Gold Layer";
    string codeContent = Demo07_CreateShortcut.Properties.Resources.BuildGoldLayer_ipynb;

    codeContent = codeContent.Replace("{WORKSPACE_ID}", WorkspaceId)
                             .Replace("{GOLD_LAKEHOUSE_ID}", GoldLakehouse.id)
                             .Replace("{SILVER_LAKEHOUSE_ID}", SilverLakehouse.id)
                             .Replace("{GOLD_LAKEHOUSE_NAME}", GoldLakehouse.displayName);
