...
public class FabricItemDefinitionFactory {
  ...
  public static FabricItemCreateRequest GetDirectLakeSalesModelCreateRequest(string DisplayName, string SqlEndpointServer, string SqlEndpointDatabase) {
    ...
    string part1FileContent = Demo4_CreateLakehouse.Properties.Resources.definition_pbidataset;

    string part2FileContent = Demo4_CreateLakehouse.Properties.Resources.sales_model_DirectLake_bim
  ...
  public static FabricItemCreateRequest GetImportedSalesModelCreateRequest(string DisplayName) {
    ...
    string part1FileContent = Demo4_CreateLakehouse.Properties.Resources.definition_pbidataset;
    string part2FileContent = Demo4_CreateLakehouse.Properties.Resources.sales_model_import_bim;
  ...
  public static FabricItemCreateRequest GetSalesReportCreateRequest(string SemanticModelId, string DisplayName) {
    ...
    string part1FileContent = Demo4_CreateLakehouse.Properties.Resources.definition_pbir.Replace("{SEMANTIC_MODEL_ID}", SemanticModelId);
    string part2FileContent = Demo4_CreateLakehouse.Properties.Resources.sales_report_json;
    string part3FileContent = Demo4_CreateLakehouse.Properties.Resources.CY24SU02_json;
