...
public class WebPageGenerator {
  ...
  static WebPageGenerator() {
    ...
    File.WriteAllText(rootFolder + "css/styles.css", Demo4_CreateLakehouse.Properties.Resources.styles_css);
    Directory.CreateDirectory(rootFolder + "js");
    File.WriteAllText(rootFolder + "js/jquery.js", Demo4_CreateLakehouse.Properties.Resources.jquery_js);
    File.WriteAllText(rootFolder + "js/powerbi.js", Demo4_CreateLakehouse.Properties.Resources.powerbi_js);
  }
  ...
  public static void GenerateReportPageUserOwnsData(string workspaceId, string reportId, bool LaunchInBrowser = true) {
    ...
    string htmlSource = Demo4_CreateLakehouse.Properties.Resources.EmbedReport_html;
