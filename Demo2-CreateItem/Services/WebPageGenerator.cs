...
public class WebPageGenerator {
  ...
  static WebPageGenerator() {
    ...
    File.WriteAllText(rootFolder + "css/styles.css", Demo2_CreateItem.Properties.Resources.styles_css);
    Directory.CreateDirectory(rootFolder + "js");
    File.WriteAllText(rootFolder + "js/jquery.js", Demo2_CreateItem.Properties.Resources.jquery_js);
    File.WriteAllText(rootFolder + "js/powerbi.js", Demo2_CreateItem.Properties.Resources.powerbi_js);
  }
  ...
  public static void GenerateReportPageUserOwnsData(string workspaceId, string reportId, bool LaunchInBrowser = true) {
    ...
    string htmlSource = Demo2_CreateItem.Properties.Resources.EmbedReport_html;
