...
public class FabricItemDefinitionFactory {
  ...
  public static FabricItemCreateRequest GetImportedSalesModelCreateRequest(string DisplayName) {
    ...
    string part1FileContent = Demo3_GitIntegration.Properties.Resources.definition_pbidataset;
    string part2FileContent = Demo3_GitIntegration.Properties.Resources.sales_model_import_bim;
  ...
  public static FabricItemCreateRequest GetSalesReportCreateRequest(string SemanticModelId, string DisplayName) {
    ...
    string part1FileContent = Demo3_GitIntegration.Properties.Resources.definition_pbir.Replace("{SEMANTIC_MODEL_ID}", SemanticModelId);
    string part2FileContent = Demo3_GitIntegration.Properties.Resources.sales_report_json;
    string part3FileContent = Demo3_GitIntegration.Properties.Resources.CY24SU02;
  ...
  public static FabricItemCreateRequest GetSalesReportCreateRequestWithPath(string SemanticModelName, string DisplayName) {

    string part1FileContent = Demo3_GitIntegration.Properties.Resources.definition_bypath_pbir.Replace("{SEMANTIC_MODEL_NAME}", SemanticModelName);
    string part2FileContent = Demo3_GitIntegration.Properties.Resources.sales_report_json;
    string part3FileContent = Demo3_GitIntegration.Properties.Resources.CY24SU02;
