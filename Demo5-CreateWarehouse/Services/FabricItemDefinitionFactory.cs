...
public class FabricItemDefinitionFactory {
  ...
  public static FabricItemCreateRequest GetDirectLakeSalesModelCreateRequest(string DisplayName, string SqlEndpointServer, string SqlEndpointDatabase) {
    ...
    string part1FileContent = Demo5_CreateWarehouse.Properties.Resources.definition_pbidataset;

    string part2FileContent = Demo5_CreateWarehouse.Properties.Resources.sales_model_DirectLake_bim
  ...
  public static FabricItemCreateRequest GetSalesReportCreateRequest(string SemanticModelId, string DisplayName) {
    ...
    string part1FileContent = Demo5_CreateWarehouse.Properties.Resources.definition_pbir.Replace("{SEMANTIC_MODEL_ID}", SemanticModelId);
    string part2FileContent = Demo5_CreateWarehouse.Properties.Resources.sales_report_json;
    string part3FileContent = Demo5_CreateWarehouse.Properties.Resources.CY24SU02_json;
