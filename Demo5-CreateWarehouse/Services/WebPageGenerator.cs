...
public class WebPageGenerator {
  ...
  static WebPageGenerator() {
    ...
    File.WriteAllText(rootFolder + "css/styles.css", Demo5_CreateWarehouse.Properties.Resources.styles_css);
    Directory.CreateDirectory(rootFolder + "js");
    File.WriteAllText(rootFolder + "js/jquery.js", Demo5_CreateWarehouse.Properties.Resources.jquery_js);
    File.WriteAllText(rootFolder + "js/powerbi.js", Demo5_CreateWarehouse.Properties.Resources.powerbi_js);
  }
  ...
  public static void GenerateReportPageUserOwnsData(string workspaceId, string reportId, bool LaunchInBrowser = true) {
    ...
    string htmlSource = Demo5_CreateWarehouse.Properties.Resources.EmbedReport_html;
